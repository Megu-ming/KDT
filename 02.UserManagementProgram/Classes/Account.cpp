...
{
	AccountValue.AddMember("ID", 
		rapidjson::StringRef(Account.ID.data()), InAllocator);
	AccountValue.AddMember("Password", 
		rapidjson::StringRef(Account.Password.data()), InAllocator);
}
